...
macro(define_cxx_executable_target name)
    ...
    if(NOT "${dicep_ARG_UNPARSED_ARGUMENTS}" STREQUAL "")
        ...
        if(${${PROJECT_MACRO_PREFIX}_ASAN_TEST})
            ...
            target_compile_options(${PROJ_NAME} INTERFACE -DASAN_TEST_ENABLED=1 -Wno-array-bounds)
        endif()
        if(${${PROJECT_MACRO_PREFIX}_TSAN_TEST})
            set(SANITIZE_THREAD TRUE)
            target_compile_options(${PROJ_NAME} INTERFACE -DTSAN_TEST_ENABLED=1)
        endif()
        if(${${PROJECT_MACRO_PREFIX}_ASAN_TEST} OR ${${PROJECT_MACRO_PREFIX}_TSAN_TEST})
            find_package(Sanitizers)
            add_sanitizers(${PROJ_NAME})
        endif()
