...
macro(find_lexer FlexMinVer BisonMinVer)
    ...
    if(FLEX_FOUND)
        if(NOT ${FLEX_INCLUDE_DIR}) # notfound?
            set(FLEX_INCLUDE_DIR "/usr/include/flex")    # specially for ubuntu 22.04
            set(FLEX_INCLUDE_DIRS ${FLEX_INCLUDE_DIR})
        endif()
        message(STATUS "- FLEX ${FLEX_VERSION} FOUND: ${FLEX_EXECUTABLE}, inc: ${FLEX_INCLUDE_DIR} / ${FLEX_INCLUDE_DIRS} / ${FLEX_LIBRARIES} - BUILT FOR ${FlexTarget}")
